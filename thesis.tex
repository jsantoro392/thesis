...
\subsection{GRB 190425089}
	...
	Initially the folllow-up analysis of this GRB was carried out using data from all three available GW detectors.
        ...
        \fpg{Sono qui.} \fpg{Anche qua, se poi l'analisi \`e fatta con H1L1, hai evidenziato il problema con V1 e puoi passare direttamente all'analisi definitiva (sia per i plot che per la descrizione).}
...
\fpg{E qui dovrai spiegare cosa \`e un chunk, che hai usato solo due IFO, che i dati non erano con la calibrazione finale.}
	...
	identified by their start and stop times (in GPS seconds). \fpg{S\`i ma in base a che vengono divisi i chunks?  Il run parte e si apre il chunk 1: come se ne sceglie la fine?}
