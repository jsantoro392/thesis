...
During the third LIGO-Virgo observing run (O3),
	...
	We present the results of the {\ttfamily PyGRB} analysis of three GRBs that occurred during O3a \cite{43}, and
...
\label{sec:pycbc00}
	...
	I will not disclose any of the foreground, but I will limit the discussion to the analysis of the background.
        ...
        \begin{figure}[!t]
          \noindent
          \label{snrhistogram}
          \makebox[\textwidth]{\includegraphics[width=0.5\textwidth]{H1-PLOT_HIST_SUMM_SNR_FULL_DATA-1260840710-742144}
            \includegraphics[width=0.5\textwidth]{L1-PLOT_HIST_SUMM_SNR_FULL_DATA-1260840710-742144}}
          \makebox[\textwidth]{\includegraphics[width=0.5\textwidth]{H1-PLOT_HIST_SUMM_NEWSNR_FULL_DATA-1260840710-742144}
            \includegraphics[width=0.5\textwidth]{L1-PLOT_HIST_SUMM_NEWSNR_FULL_DATA-1260840710-742144}}
          \centering
          \caption{Histograms of the SNR (\textit{top}) and of the re-weighted SNR (\textit{bottom}) for the background events of the Hanford detector (\textit{left}) and the Livingston detector (\textit{right}).}
	...
	Typically, the time-shift used to construct HL backgrounds is 0.1\,s.
...
% Anche qui da quello che vedo il discorso fila poco.  Dividi in
% capoversi, batti sulla centralit\`a della template bank per fare un
% intero run, riporta i risultati delle 3 GRB, evidenzia la
% pubblicazione, ecc.
