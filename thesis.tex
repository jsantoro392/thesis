...
%        meaning for the orbit close to the last one with $r \sim 6G(M_{BH}+M_{NS})$.
	...
	and $C_{NS} = 0.13-0.182$.
                \begin{figure}[H]
                        ...
                        \centering
                        \caption{This figure shows a comparison between the template bank constructed for the second observing run, which made use of the old model $\ref{eq:mrem}$, and the template bank generated implementing the updated model $\ref{eq:mremup}$.}  
