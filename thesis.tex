...
\end{table}
	...
	This template bank was generated with a hybrid geometric random method and uses a 
        phenomenological inspiral merger bringdown waveform model, IMRPhenomD \cite{205}, 
        for non precessing point particle binaries, for aligned spin BNS and aligned spin NSBH that produce EM counterpart.
	The NS can have mass $1M_\odot \leq M_{NS}  \leq 2.8M_\odot$
	and dimensionless spin magnitude of $\leq 0.05$, which is based on NS parameters from known Galactic BNS systems \cite{206},
	while the parameters range for the BH is $1M_\odot \leq M_{BH}  \leq 25M_\odot$ and $0 \leq \chi_{BH} \leq 0.998$.
		\begin{figure}[H]
                        \noindent
                        \label{banktest}
                        ...
                        \label{fig:banktest}
                \end{figure}
        In order to asses the efficiency of the bank we perform some test to calculate the fitting factor, 
	introduced in Sec.$\ref{subsec:fittingfactor}$.
