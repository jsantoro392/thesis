...
\chapter{Gravitational wave observation so far}
	...
	during the last two observing runs LIGO, various enhancements 
	beyond the original design improved its sensitivity up to a $20\%$  
	as measured by the by the BNS range \cite{53,54},
	...
	The first GW direct observation was achieved after LIGO began observing in an upgraded program called Advanced LIGO, 
	...
	A total of eleven confident detections were collected from the O1 and O2 data: The GW Transient Catalog (GWTC-1) %warning: mettere a  posto citazione%
	ten BBH mergers \cite{52, 57-60} and one BNS merger \cite{61} and fourteen marginal triggers.
	...
	has been observed from a single source \cite{62}. \\
	Data from GW detectors are searched by detection pipelines, which look for many types of possible signals %warning:(Abbott et al. 2018f)%. 
	...
	thus, our observations provide an extraordinary opportunity to test 
	...
	Lower mass systems, lasting for many more cycles in the detector data, 
...
\section{O1: first observing run}
	...
	involved the Hanford and Livingston detectors which provided unprecedented sensitivity to GW 
	over a range of frequencies from 30 Hz to several kHz \cite{108}, 
	...
	they both use a discrete template bank \cite{114, 115-120}, which targets GW from binaries with individual masses from 1${M_\odot}$  to 99 ${M_\odot}$,
...
\subsection{GW150914 BBH first detection}
	...
	The era of GW astronomy began with the detection of the merger of two stellar-mass BHs, GW150914, 
	on September 14, 2015 at 09:50:45 UTC with a matched-filter SNR of 23.7 \cite{BBH mergers}. 
	...
	This corresponds to a p-value of $7.5 × 10^{-8}$, or a significance of $5.3\sigma$. \\
	\textbf{Masses} \\ 
	...
	GW150914 corresponds to the heaviest BBH system, $M^{source} = 65.3^{+4.1}_{-3.4}M_\odot$ and came from a near equal-mass system of $36^{+5}_{-4}M_\odot$ and $29^{+4}_{-4}M_\odot$ \cite{}%warning missing cite%.
	...
	total mass of the binary components, as similar fractions of 0.02–0.05 are radiated away as gravitational waves. 
	...
	All of these channels have been shown to be consistent with the GW150914 discovery \cite{63-70}. 
		\begin{figure}
				 ...
				 The dashed black lines indicate 1s deviations expected in Gaussian noise.} %warning missing cite 1 article%
                	\label{fig:firstgw}
                \end{figure}
...
\subsection{GW151226 22-Solar-Mass BBH Coalescence}
	...
	was observed by the twin LIGO detectors on December 26, 2015 at 03:38:53 UTC, with a combined matched-filter SNR of 13.0. 
	...
	Signal consistency tests show no sign of transient noise affecting the analyses at this time, 
	and checks of the instrumental data reveal no serious data quality issues at the time of the event. 
	...
	and the event is recovered with a FAR of 1 per 44000 years, which corresponds to a p-value of $3.5 × 10^{-6}$ and a significance of $4.5\sigma$. 
	...
	This is above the expected maximum NS mass of about $3M_\odot$ \cite{121, 122} 
	...
	The remnant BHs from the BBH observed in O1 are more massive than any BH observed to date in an x-ray binary, 
	the least massive being GW151226’s $M^{source}_f = 20.8^{+6.1}_{-1.7}M_\odot$.
	...
	However, the two LIGO detectors are nearly coaligned and the source of GW151226 is likely to be located close to the maxima of the directional responses of both detectors \cite{110}. 
...
\subsection{GW151012 revaluated BBH}
	...
	The trigger occurred on UTC 2015-10-12 09:54:43, 
	and considering it had an SNR of 9.7, it was initially classified as a LIGO/Virgo Transient, 
...
\section{O2: second observing run}
	...
	During O2, on the 1st August 2017, Advanced Virgo joined the two Advanced LIGO detectors for the first time, 
	taking sensitive data about 80\% of the time \cite{55}.  \\
	Between O1 and O2 run the sensitivity of both LIGO instruments was improved and 
	at LIGO Livingston (LLO) further improvements were made during O2. 
	...
	Of the eight GW signals detected during O2, five were localized by the three detector LIGO-Hanford, LIGO-Livingston and Virgo (HLV) network. 
	...
	The searches can target BBH mergers with detector-frame total masses $2M_\odot \leq M^{det} \leq 100–500 M_\odot$,
...
\subsection{GW170104 50-Solar-Mass BBH Coalescence}
	...
	The observation of GW170104 was made on January 4, 2017 at 10:11:58.6 UTC by LIGO detectors, 
	...
	The BH spins are best constrained through measurement of the effective inspiral spin parameter, 
	...
	for spins with positive projections along the orbital angular momentum \cite{133}.
	The source luminosity distance is $880^{+450}_{−390} Mpc$ corresponding to a redshift of $z = 0.18^{+0.08}_{−0.07}$. 
	Stars loose mass throughout their lives; to leave a heavy BH as a remnant 
	...
	The inferred merger rate agrees with previous calculations \cite{136, 137}, and could potentially be explained 	
...
\subsection{GW170608 19 Solar-mass BBH Coalescence}
	...
	at frequencies above 30Hz. A segment of LHO data around the event time was then 
	searched with a filter starting frequency of 30Hz, using templates approximating 
	the waveforms from compact binary systems with component spins aligned with the orbital angular momentum.
	...
	The initial binary of GW170608 consisted of two compact objects with source-frame component masses 
	$m_1 =12^{+7}_{-2}M_\odot$ and $m =7^{+2}_{-2}$ 
	Since NSs are expected to have masses below $\sim 4M_\odot$ \cite{141},
	both objects are most likely BHs. 
	The effective inspiral spin $\chi_{eff}$, a mass-weighted combination 
	of the spin components (anti-)aligned with the orbital angular momentum \cite{139} 
	predominantly affects the inspiral rate of the binary but also influences the merger. 
	The $\chi_{eff}$ inferred from this event is $0.07^{+0.23}_{−0.09}$
	disfavoring large, anti-aligned spins on both BH.
	The distance of GW170608 is extracted from the observed signal amplitude given 
	the binary’s inclination \cite{140}. With the network of two nearly co-aligned LIGO detectors, 
	the uncertainty on inclination translates into a large distance uncertainty: 
	the inferred luminosity distance is $D_L = 340^{+140}_{−140}Mpc$, 
	corresponding to a redshift of $z = 0.07^{+0.03}_{−0.03}$.
	GW170608 is localized to a sky area of $\sim520 deg^2$, determined largely by the signal’s measured arrival time at LLO $\sim7$ ms later than at LHO. 
...
\subsection{GW170814 Three-detector Observation of BBH Coalescence}	
	...
	low-latency matched-filter pipelines \cite{143-149},
	with a Hanford-Livingston network SNR of 15 and a three-detector network SNR of 18,
	with ranking statistic values from the two pipelines c
	The significance estimates for this event found by the two matched-filter pipelines 
	did not use data from Virgo for significance estimates: 
	ranking statistic values from the two pipelines correspond to 
	a false-alarm rate of 1 in 140 000 years in one search \cite{143, 144} 
	and 1 in 27 000 years in the other search \cite{145-150}, 
	...
	which includes Virgo data to improve significance estimates. 
	...
	The parameters of the source are inferred through a coherent Bayesian analysis \cite{152, 153} 
	of offline noise-subtracted data for the LIGO and Virgo detectors 
	using two independently developed waveform models. 
	Both of these waveform models are calibrated to partially overlapping 
	sets of numerical-relativity simulations of binary black hole coalescences 
	One model includes the full two-spin inspiral dynamics in 
	the absence of precession \cite{154-160}, 
	whereas the other model includes an effective treatment of the spin-precession 
	dynamics through a rotation of an originally nonprecessing model \cite{161-164}. 
	The inferred masses of the initial black BH are $30.5^{+5.7}_{-3.0}M_\odot$ 
	...
	Including Virgo in the search allows for the first time to investigate GW polarizations, by geometrically 
	by projecting the wave’s amplitude onto the three detectors , 
	since the two LIGO instruments have similar orientations, therefore little information 
	about polarizations can be obtained using the LIGO detectors alone. 
	...
	and from the rapidly changing GW phase of BBH mergers observed by LIGO, in the framework of parametrized models \cite{177- 179}.
...
\subsection{Gamma Ray Burst}
	...
	GRBs are brief, $\Delta t \sim 0.1–100s$, intense, flashes of high-energy, 1 keV–10 MeV, radiation 
	...
	after ploughing into the external medium surrounding the source \cite{183-185}. 
	...
	At the shock, electrons are accelerated by the Fermi process and radiate mainly by synchrotron emission\cite{187,188}. 
	...
	are not spherical but collimated into narrow jets \cite{189}. 
	...
	are isotropically distributed, meaning they occur everywhere in the cosmos \cite{190}.
	...
	and a possible source of (ultra) high-energy cosmic rays \cite{191,192}. 
...
\subsection{GW170817: first BNS detection}
	...
	a coincident GW trigger by LIGO occurred $\sim1.7s$ prior to the announcement of a GBM trigger \cite{200},
	which was later designated GRB170817A \cite{201}.
	...
	The GW170817 candidate was registered in low latency \cite{202,203}
	based on a single-detector analysis LHO data. 
	Rapid offline re-analysis \cite{204, 205} of data from the LIGO/Virgo network 
	confirmed the presence of a significant coincident signal in the LIGO GW detectors with a combined SNR of 32.4. 
	The offline analysis identified GW170817 with a false-alarm rate of less than 1 in 80,000 years \cite{206}. 
	A coherent Bayesian analysis \cite{207,208}
	inferred the GW source localisation in a region of $28 deg^2$ at a distance of $40^{+8}_{-14}$ Mpc, 
	consistent with the early estimates disseminated through GCN Circulars \cite{209, 210}. 
	...
	\cite{213,218,219} and uses the GBM localization of GRB170817A 	
	...
	Standard follow-up analyses \cite{220-222} of the Fermi-GBM trigger 
	determined the burst duration to be $T_{90} = 2.0 \pm 0.5 s$,
	From the Fermi-GBM $T_{90}$ measurement, GRB 170817A was classified as an sGRB with 3:1 odds over being a long GRB. 
	The classification of GRB170817A as an sGRB is further supported by incorporating 
	the hardness ratio of the burst and comparing it to the Fermi-GBM catalog \cite{223}. 
	...
	and delayed X-ray and radio counterparts that provide information on the environment of the binary. 
	...
	is the confirmation that these binaries are indeed the progenitors of at least some SGRBs. 
		\begin{figure}
				 ...
				 The background estimate from %cit Goldstein et al. (2016)% 
				 is overlaid in red.   
				 ...
				 trigger time $T_0^{GW}$.}%warning missing cite 1 article Gravitational Waves and Gamma-Rays from a Binary Neutron Star Merger: GW170817 and GRB 170817A%
                        \label{fig:gw-grb}
                \end{figure}
...
\subsection{GW190425: Observation of a compact binary coalescence with total mass ~3.4 Msun}
	...
	a BH smaller than any BH detected so far.
	...
	louder than any background event. 
	The binary heaviest component mass is between $1.61$ and $2.52 M_\odot$, 
	while the mass of the second object between $1.12$ and $1.68 M_\odot$.
...
.	Currently, there are 17 known galactic neutron star pairs with measured total masses 
	...
	GW190425’s unusual mass may have implications for the system’s origin.
	...
	on the number of NS that collide in a volume of the universe every year of $250–2810 Gpc^{-3}yr^{-1}$ \cite{224}.
		...
		\begin{figure}
				 ...
				 indicated with the grey histogram bars and the dashed line. \cite{224}}
		        \label{fig:secondbns}
                \end{figure}
...
\subsection{GW190412: Observation of a Binary-Black-Hole Coalescence with Asymmetric Masses}
	...
	Therefore, the GW frequency from each of the BH’ orbit was different: 
	...
	Gravitational radiation from CBC was shown to be predominantly quadrupolar \cite{225-227} 
	and is observed as a combination of two polarizations, weighted with the detector response functions $\ref{label 2.51}$.
	...
	respect orbital symmetry and so are present in the radiation \cite{228}, resulting in the quadrupole, $h_{22}$, 
	...
	multipoles with $l = m$ gain increasing importance \cite{228-233}. 
	GWs of higher harmonics had not been observed until GW190412:
	these higher multipoles makes a significant, measurable contribution to the observed data as shown in \cite{234}.
	...
	and how clearly unequal-mass system are less unlikely but still expected to form in the universe. \cite{234}
...
\begin{thebibliography}{1}
	...
	\bibitem{55} B.P. Abbott et al. (LIGO Scientific Collaboration and Virgo Collaboration). GWTC-1: A Gravitational-Wave Transient Catalog of Compact Binary Mergers Observed by LIGO and Virgo during the First and Second Observing Runs. Phys. Rev. X 9, 031040.
	...
	\bibitem{63} K. Belczynski, D. E. Holz, T. Bulik, and R. O’Shaugh- nessy, The First Gravitational-Wave Source from the Isolated Evolution of Two 40-100 Msun Stars, Nature (London) 534, 512 (2016)
...
        \bibitem{117} L. A. Wainstein and V. D. Zubakov, Extraction of Signals from Noise (Prentice-Hall, Englewood Cliffs, NJ, 1962). 
	...
	\bibitem{133} B. Abbott et al. (LIGO Scientific Collaboration, Virgo Collaboration), Phys. Rev. Lett. 116, 241103 (2016), arXiv:1606.04855 [gr-qc]. 
	\bibitem{134} B. P. Abbott et al. (LIGO Scientific Collaboration, Virgo Collaboration), Astrophys. J. Lett. 818, L22 (2016), arXiv:1602.03846 [astro-ph.HE]. 
	...
	\bibitem{153} B. P. Abbott et al. (LIGO Scientific Collaboration and Virgo Collaboration), Phys. Rev. Lett. 116, 241102 (2016). 
	...
	\bibitem{158}T. Damour and A. Nagar, Phys. Rev. D 79, 081503 (2009). E. Barausse and A. Buonanno, Phys. Rev. D 81, 084024 (2010).
	...
	\bibitem{162} S. Khan, S. Husa, M. Hannam, F. Ohme, M. Pürrer, X. J. Forteza, and A. Bohé, Phys. Rev. D 93, 044007 (2016). 
	...
	\bibitem{168} S. Fairhurst, New J. Phys. 11, 123006 (2009); 13, 069602 (E) (2011). 
 	...
 	\bibitem{177} B. P. Abbott et al. (LIGO Scientific Collaboration and Virgo Collaboration), Phys. Rev. Lett. 116, 061102 (2016). 
 	\bibitem{178} B. P. Abbott et al. (LIGO Scientific Collaboration and Virgo Collaboration), Phys. Rev. Lett. 118, 221101 (2017). 
 	\bibitem{179}  B.P. Abbott et al. (LIGO Scientific Collaboration and Virgo Collaboration), Phys. Rev. Lett. 116, 221101 (2016).
	\bibitem{180} Klebesadel et al., 1973.
	\bibitem{181} Rees and Meszaros, 1992; Begelman et al., 1993.
	\bibitem{182} Gehrels et al. 2009.
	\bibitem{183} Meszaros and Rees, 1993.
	\bibitem{184} Meszaros et al., 1994.
	\bibitem{185} Meszaros and Rees, 1997.
	\bibitem{186} Rees and Meszaros, 1992. 
	\bibitem{187} Paczynski and Rhoads, 1993.
	\bibitem{188} Meszaros and Rees, 1993, 1997a.
	\bibitem{189} Sari et al., 1999.
	\bibitem{190} Meegan et al., 1992.
	\bibitem{191} A. M. Hillas, The origin of ultra-high-energy cosmic rays, ARAA 22, 425 (1984).
	\bibitem{192} B. Zhang, The Physics of Gamma-Ray Bursts (Cambridge University Press, 2018).
	\bibitem{193} Barthelmy et al. 2005.
	\bibitem{194} Prochaska et al. 2006 
	\bibitem{195} Berger et al. 2007 
	\bibitem{196} Ofek et al. 200.
	\bibitem{197} D’Avanzo et al. 2009.
	\bibitem{198} Fong et al. 2013.
	\bibitem{199} Troja et al. 2008.
	\bibitem{200} LIGO Scientific Collaboration and Virgo Collaboration 2017a.
	\bibitem{201} von Kienlin et al. 2017.
	\bibitem{202} Cannon et al. 2012.
	\bibitem{203} Messick et al. 2017.
	\bibitem{204} Usman et al. 2016.
	\bibitem{205} Nitz et al. 2017b.
	\bibitem{206} Abbott et al. 2017e.
	\bibitem{207} Veitch et al. 2015
	\bibitem{208} Abbott et al. 2016b.
	\bibitem{209} LIGO Scientific Collaboration and Virgo Collaboration et al. 2017b. 
	\bibitem{210} LIGO Scientific Collaboration and Virgo Collaboration et al. 2017c.
	\bibitem{211} Harry and Fairhurst 2011. 
	\bibitem{212} Williamson et al. 2014 
	\bibitem{213} Abbott et al. 2017b.
	\bibitem{214} Nitz et al. 2017a. 
	\bibitem{215} Coulter et al. 2017a.
	\bibitem{216} Coulter et al. 2017b.
	\bibitem{217} Abbott et al. 2017f.
	\bibitem{218} Sutton et al. 2010.
	\bibitem{219} Was et al. 2012.
	\bibitem{220} Goldstein et al. 2012.
	\bibitem{221} Paciesas et al. 2012. 
	\bibitem{222} Gruber et al. 2014.
	\bibitem{223} Goldstein et al. 2017a.
	\bibitem{224} B. P. Abbott et al. GW190425: Observation of a Compact Binary Coalescence with Total Mass ~ 3.4 Msun. 2020 ApJL 892 L3. doi:10.3847/2041-8213/ab75f5.
	\bibitem{225} K. S. Thorne, Rev. Mod. Phys. 52, 299 (1980). 
	\bibitem{226} A. Einstein, Sitzungsber. Preuss. Akad. Wiss. Berlin (Math. Phys. ) 1918, 154 (1918). 
	\bibitem{227} E. T. Newman and R. Penrose, Journal of Mathematical Physics 7, 863 (1966). 
	\bibitem{228} L. Blanchet, Living Rev. Relativ. 9 (2006). 
	\bibitem{229} L. Blanchet, G. Faye, B. R. Iyer, and S. Sinha, Classical and Quantum Gravity 25, 165003 (2008). 
	\bibitem{230} L. E. Kidder, Phys. Rev. D 77, 044016 (2008). 
	\bibitem{231} J. Healy, P. Laguna, L. Pekowsky, and D. Shoemaker, Phys. Rev. D 88, 024034 (2013). 
	\bibitem{232} L. London, D. Shoemaker, and J. Healy, Phys. Rev. D 90, 124032 (2014). 
	\bibitem{233} C. K. Mishra, A. Kela, K. G. Arun, and G. Faye, Phys. Rev. D 93, 084054 (2016). 
	\bibitem{234}
\end{thebibliography}
