...
\label{subsec:pygrb}
	...
	The re-weighting is done in two steps: first according  to  the  $\chi^2$ value
		\begin{equation}
		\text{if} \hspace*{0.5cm} \chi^2 \leq n_{dof} \hspace*{3.9cm} \rho_{\chi^2} =  \rho_{\rm coh} 
		\end{equation}
		\begin{equation}
		\text{if} \hspace*{0.5cm} \chi^2 > n_{dof} \hspace*{1.2cm} \rho_{\chi^2} =  {{\rho_{\rm coh}}  \over {\{[1+ \big( {{\chi^2} \over {n_{dof}}} \big)^3 ]/2\}^{1/6}}}
		\end{equation}	
