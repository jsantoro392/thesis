...
\subsection{Ring of Test Masses}
        ...
        the only non zero compontents of the metric perturbation are
                ...
                \end{equation}
        where $h_{+}=h_{+}(t-z)$ and $h_{\times}=h_{\times}(t-z)$ are the two polarization components, which are independent and can be considered separately.
        ...
        while the cross polarization exhibits the same behaviour rotated by $\ang{45}$ in the $x - y$ plane. This is shown in Figure 2.1.
                \begin{figure}[H]
                \label{ring}
...
\fpg{E qui dovrai spiegare cosa \`e un chunk, che hai usato solo due IFO, che i dati non erano con la calibrazione finale.}
	...
	Chunks of data denoted by the string ``C00'' require the final data quality checks and calibration to be carried out.
        ...
        I analyzed a chunk of C00 data running from 01:31:32 UTC on December 20, 2019 to 15:40:36 UTC on December 28, 2019.  
