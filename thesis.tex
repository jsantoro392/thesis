...
\label{subsec:o3aTemplateBank}
	...
	that targets only BNSs and NSBH systems that produce a remnant accretion disk after merger \fpg{Cita anche il paper O1, oltre alle due citazioni che seguono e che ho aggiunto.} \cite{55,136,161}, as suggested in \cite{162} \fpg{Cita Pannarale \& Ohme 2014}.  This kind of template bank is often referred to as ``EM-bright bank,'' as it targets only potentially electromagnatically bright compact binary sources.
...
%\label{subsec:mrem}
        ...
        two\footnote{See, however, \fpg{Pannarale et al 2015 ``Aligned spin [...] model''} for a more detailed classification.} possible classes of events, as depicted in Fig.\,\ref{fig:nsbh}.
        If $d_{\rm tid} \lesssim R_{\rm ISCO}$, the NS plunges into the BH, no matter is left outside the remnant BH,
        and the chances of producing an EM counterpart are very low; in this case the GW signal is practically identical to the one emitted by a BBH system with the same component masses and spins \cite{163,164,165,166,167}\fpg{Cita i miei articoli con Shibata, quello con Elisa, Matas et al 2020.}
        ...
        When this matter is present outside the final BH, EM emission is expected to emerge from a variety of processes \fpg{Citazioni?}.
        The mass of the remant accretion disk, also depends upon the NS radius $R_{\rm NS}$, as suggested in \fpg{cita Tonita, Pannarale, Rezzolla.}.
	...
	The accretion disk can spread to larger radii to conserve angular momentum in the rotational period $\sim 10\,$ms,
        ...
        and $C_{\rm NS} = 0.13$-$0.182$. \fpg{Mancano i valori dei 4 parametri...}
...
\label{subsec:construction_and_validation}
	In light of the discussion so far, an EM-bright bank cover the portion of compact binary parameter space that
        ...
        \item Galactic BHs have masses that fall in the interval $[5,-15]M_{\odot}$ \cite{124},
          but GW observations have involved BHs with higher masses \cite{13} \fpg{13 \`e l'O1-O2 CBC catalog paper: devi citare l'O3a CBC catalog paper}.
...
%	data from each detector is time-shifted so that there is a temporal coincidence between the GW and the GRB in each IFO \cite{92}.
	...
	All simulated signals are modelled using the {\ttfamily SEOBNRv3} waveform approximant \fpg{Citazione}, which differs from the {\ttfamily IMRPhenomD} waveform model used to generate the templates: this is intentional and factors in our incomplete knowledge about waveforms.
...
\begin{thebibliography}{500}
	...
	\bibitem{163} F. Pannarale, E. Berti, K. Kyutoku, B. D. Lackey, M. Shibata. Gravitational-wave cutoff frequencies of tidally disruptive neutron star-black hole binary mergers. doi:10.1103/PhysRevD.92.081504.
	...
	\bibitem{165}  F. Pannarale, E. Berti, K. Kyutoku, M. Shibata. Nonspinning black hole-neutron star mergers: a model for the amplitude of gravitational waveforms. Physical Review D 88, 084011 (2013). 10.1103/PhysRevD.88.084011.
