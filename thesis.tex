...
%
\fpg{In vari punti usi {\ttfamily cite\{\}} oppure {\ttfamily ref\{\}}. Inoltre citi senza averle in biblio 213 e 215.}%
...
\section{The Third Observing Run (O3)}
	...
	as well as a binary, whose smallest component is an unidentified massive compact object \cite{207}.
        ...
        \end{figure}
%Non so se dire di più in generale su O3a che non crei squilibrio con le intro degli altri observing run. Potrei parlare citando O3a, dei risultati finali della GW search w/ GRBs?
