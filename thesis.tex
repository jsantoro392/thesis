...
\subsubsection{Coherent False Alarm Probability}
	...
	the FAP of the on-source trigger is then the fraction of off-source trials containing a loudest trigger  than the on-source \cite{46}.
