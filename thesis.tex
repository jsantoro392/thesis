...
\subsection{GRB190627A}
	...
	H1 with 0.316, and L1 with 0.452.
                \begin{figure}[H]
                        ...
                        \makebox[\textwidth]{\includegraphics[scale=0.3]{scienceseggrb1}}%
                        \centering
	...
	will place themselves at low values, while the background triggers should be found with high values. 
		...
		\begin{figure}[H]
                        \noindent
                        \label{detector1}
                        \makebox[\textwidth]{\includegraphics[scale=0.3]{detector1}}%
                        \centering
	...
	therefore the missed injection is due to differences between the IMRPhenomD and SEOBNRv3 modules.
                \begin{figure}[H]
                        \noindent
                        \label{missinj1}
                        \makebox[\textwidth]{\includegraphics[scale=0.3]{missinj1}}%
                        \centering
                        \caption{Plots of the injections distance against time. Each panel represents a different injections set: on the left BNS set with precessing spins, on the righ NSBH sets with aligned spins.}
                        \label{fig:missinj1}
                \end{figure}
                ...
                \begin{figure}[H]
                        ...
                        \makebox[\textwidth]{\includegraphics[scale=0.3]{loudestoffsourcevent1}}%
                        \centering
                        \caption{}
                ...
                \begin{figure}[H]
                        \noindent
                        \label{detectionefficiency1}
                        \makebox[\textwidth]{\includegraphics[scale=0.3]{detectionefficiency1}}%
                        \centering
                        \caption{}
                        \label{fig:detectionefficiency1}
                \end{figure}

                \begin{figure}[H]
                        \noindent
                        \label{exdistance1}
                        \makebox[\textwidth]{\includegraphics[scale=0.3]{exdistance1}}%
                        \centering
                        \caption{}
                        \label{fig:exdistance1}
                \end{figure}
