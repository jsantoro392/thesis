...
\label{subsec:coherent}
	...
	to effectively construct a single, more sensitive detector.
 	While this method is applied to searches for unmodelled burst sources,
        it is computationally expensive in the case of modelled searches \cite{45}.  It is therefore used for externally triggered searches, when knowing the time- and sky-location of the source can cut the cost of the search.
...
\subsection{GW190521}
	\fpg{Sono qui.} \fpg{Giri di correzione:0}. The BBH that produced the GW event GW190521 was the most massive and energetic BH merger yet,
...
\subsection{GW190814}
	\fpg{Giri di correzione:0}. This was the most exciting yet puzzling observation so far, since the initial source classification,
