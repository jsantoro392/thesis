...
%\end{table}
	...
	which is consistent with the bank average from the broad injection set. 
                \begin{figure}[!t]
                        \noindent
                        \label{pointinj}
                        \makebox[\textwidth]{\includegraphics[scale=0.3]{pointinj}}%
                        \centering
