...
\subsection{Missed Injections}
        Figure \ref{fig:missed_inj} summarizes the result of the injection campaigns carried out on the chunk of O3b data.  \fpg{Si fanno $N$ injections, con  waveform model... e prior sui parametri... (forse sono gi\`a scritti da qualche parte nella tesi).  Aggiornare la parte seguente alla luce dei due pannelli.} Each point here represents an injection; it is placed in the plot according to its chirp mass and optimal SNR, a measure of the SNR of the injected waveform assuming no noise is present, and it is coloured according to the outcome of its recovery: a red cross is an injection that was not recovered, while circles are recovered injections coloured by their FAR, the dark blue ones being identified undoubtedly as signals, that is, they were found to be louder than all background events.
         ...
         \begin{figure}[t]
          ...
          \centering
          \caption{{\bf Injeciton results.} {\textit Left:} Each point represents the source of a simulated GW signal injected in the data and recovered from it.  The horziontal axis reports the chirp mass of the source, while the veritcal one is the optimal SNR of the signal, a measure of the SNR of the injected waveform assuming no noise is present. Red crosses are injections that was not recovered, while circles are recovered injections coloured by their FAR. {\textit Right:} In this case the vertical axis is the distance to the source.}
