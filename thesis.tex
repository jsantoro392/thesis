...
\fpg{Giri di correzione: 1.}%
	More than 100 years ago, Albert Einstein predicted the existence of gravitational waves (GWs) starting from his theory of general relativity \cite{1}\cite{2}.
...
\subsection{GW170814: the First Three-Detector Network Observation}	
	...
	low-latency matched-filter pipelines \cite{43,109,111,112,114,146},
...
\label{subsec:GW170817}
	...
	\cite{43,55,114} and it allows for a $[-600, +60]\,$s search window,
...
\label{subsec:GW190425}
	...
	BHs with masses smaller than any BH mass observed so far \cite{28}.
	...
	louder than any background event up to its detection \cite{28}.
	...
	The unusual total mass of GW190425 may have implications for the origin of its source \cite{28}.
