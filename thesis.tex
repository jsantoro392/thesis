...
\subsection{GRB 190627A}
	...
	defined as the distance within which 90\% of the injections of a given set is recovered.
        ...
        \end{figure}
	The on-source results show that there is no significant event, 
	and the $D_{90}$ recovered for the three injection sets are 115 Mpc for BNS, 
	139 Mpc for the precessing NSBH, and 211 Mpc for the aligned NSBH.
...
\fpg{Devi raccontare direttamente il run finale.  La descrizione qui sotto riguarda i plot del primo run.  Se io guardo Fig.\,\ref{fig:scplots2_final}, non ritrovo quello che scrivi.  Infatti ci sono 2/3 injections per auto veto e una per lo standard chi-square.} 
	...
	with just two vetoed injections.
        ...
        \begin{figure}[!t]
          ...
          \makebox[\textwidth]{\includegraphics[scale=0.68]{scplots2_final}}%
          \centering
	...
	A high NS spin magnitude was also found for the nearby NSBH injections that were not recovered as louder than all the background events.
        \begin{figure}[!t]
          ...
          \makebox[\textwidth]{\includegraphics[scale=0.55]{detector2_final}}%
          \centering
	...
	The $D_{90}$ found in the on-source window are 160 Mpc, 204 Mpc and 272 Mpc for the BNS, the precessing and aligned NSBH, respectively. 
\begin{comment}
\begin{tabular}{ |p{3cm}||p{3cm}|p{3cm}|p{3cm}|  }
 \hline
 Source & $D_{90}$\\
...
\subsection{GRB 190425089}
	...
	Initially the follow-up analysis of this GRB was carried out using data from all three available GW detectors.
 	...
 	Therefore, the analysis has been conducted without V1.
	...
	and the on-source data results were investigated: 
	the recovered 90\% exclusion distance for BNS, generic spin NSBH and aligned spin NSBH are 204 Mpc, 247 Mpc and 440 Mpc, respectively.
	The most significant event in the on source data has a FAP of 0.075.
\begin{comment}
\begin{tabular}{ |p{3cm}||p{3cm}|p{3cm}|p{3cm}|  }
 \hline
 Source & $D_{90}$\\
