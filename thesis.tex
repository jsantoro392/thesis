...
\fpg{Rifare sulla falsa riga della precedente sezione.}
        ...
        while the auto veto vetoes several injections, as seen in Fig.\,\ref{fig:scplots2}.
                \begin{figure}[h]
                        ...
                        \centering
                        \caption{\textbf{Signal consistency plots.} Same as Fig.$\ref{fig:signalconsistencyplots1}$ but for GRB 190728271. \fpg{Anche questo plot va ridotto ad una colonna.}}
                        \label{fig:scplots2}
                \end{figure}
