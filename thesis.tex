...
% pubblicazione, ecc.
	...
	reported during the O3a LIGO-Virgo observing run and published in \cite{}: 
	...
	for the third  LIGO-Virgo observing run \cite{}, no GW candidate event was found since 
