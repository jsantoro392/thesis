...
\end{table}
        ...
        A visual illustration of the template bank generated with the implementation of the new formula is shown in Fig.$\ref{fig:banktest}$:
        it is built with a hybrid geometric random method and uses a phenomenological inspiral merger bringdown waveform model for non precessing point particle binaries.
