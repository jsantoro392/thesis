 with just one injection falling o\documentclass[binding=0.6cm, LaM]{sapthesis}
...
\fpg{Giri di correzione: 1.}%
	...
	the conditions under which an EM component is present are discussed in Sec.\,\ref{sec:grbfollowup}.
...
\subsection{GRB 190627A}
	...
	Since the precessing NSBH injection set has a behaviour in between the BNS and aligned NSBH set,
...
\subsection{GRB 190425089}
	...
	follow the expected astrophysical trend overall, with just one  injection falling out the  3$\sigma$ deviation.
	                \begin{figure}[!t]
                        ...
                        \makebox[\textwidth]{\includegraphics[scale=0.5]{detector3_final}}%
                        \centering
                        \caption{\textbf{Signal consistency plots.} Same as Fig.\,\ref{fig:detector1} but for GRB 190425089.}
