...
\label{subsec:fittingfactor}
	...
	and is proportional to the signal power \cite{125} \fpg{Referenza mancante}. 
	...
	\end{equation}
	which can be interpreted as the average SNR recovered for the observed population of sources \cite{127} \fpg{Referenza mancante}.
