...
\fpg{Giri di correzione: 0.}%
	...
	The resulting EM-bright template bank has been tested to asses its efficiency, as described in Sec.$\ref{subsec:construction_and_validation}$. \\
...
\subsection{GRB 190627A}
	...
	the circles are colour-codeded with the FAP of the recovered trigger (\fpg{see Sec.\,\ref{...} for the definition of FAP within this search}).  It is therefore expected that circles dominate an intermediate transition regime from not confidently recovered injections (blue crosses) to not recovered injections (black crosses).
	We note that missed injections can also occur within the network's range.  Aside from the aforementioned case of glitches being present in the data, this can be also be due to discrepancies between 
