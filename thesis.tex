...
\fpg{Sono qui.}
	The EM-bright bank parameter space must cover a parameter space,
        ...
        but BHs observed through GWs are often more massive \cite{13}. \\  % FP: 13 is the O2 GRB paper.
        ...
        The effect of a small inclination angle on the relative amplitudes of the two GW polarisations
        ...
        The new model covers previously unmodelled regions of the parameter space, comparable masses $q \sim 1$ and high spins,
	...
	because as the mass increases, the waveforms get shorter and start to overlap more with each other. \\
        ...
        This choice leads to a lager value for $R_{\rm ISCO}$ when considering a binary with $q \sim 1$,
        which is physically expected because the accreting NS will begin its plunge at a $R_{\rm ISCO}^{effective}$,
        ...
        This gives a more precise estimation for $M_{\rm rem}$, which was previously overestimated for nearly equal-mass NSBH.
        ...
        with a rapidly spinning BH, leading to an underestimation of $M_{\rm rem}$,
