...
\fpg{Rifare sulla falsa riga della precedente sezione.}
        ...
        The Fermi Gamma-ray Burst Monitor (GBM) triggered and located GRB 190728271 at 06:30:36 UT on 28 Jul 2019.
  	...
  	By looking at the Found/Missed Injection plots in Fig.\,\ref{fig:missinj2},
        ...
        return a match of $\sim$0.9. The third one has both a high Null SNR value and a low match ($\sim$8) between the injection and waveform model.
                \begin{figure}[h]
                        ...
                        \label{fig:missinj2}
                \end{figure}
        By rerunning the analysis with injection at higher distances partially improves the fraction of recovered injections,
        as it clear by looking at Fig.$\ref{fig:missinj2_2}$, and increases the exclusion distances and FAPs for all results.
        The number of BNS injections not confidently recovered has decreased to eighteen at nearby distances ($<$84Mpc),
        most of them have at least one spin magnitude caused by either a component having spin magnitude $>$0.05,
 	that also causes precession, excepter three injections that show a high $\chi^2$ value.
        On the other hand, the number NSBH injections has doubled: the majority was lost due to having a NS spin magnitude $>$0.05,
        the rest due to vetos.
                \begin{figure}[h]
                        \noindent
                        \label{missinj2_2}
                        \makebox[\textwidth]{\includegraphics[scale=0.4]{missinj2_2}}%
                        \centering
                        \caption{\textbf{Found/missed injections.}Same as Fig.$\ref{fig:missinj1}$ but for GRB 190728271. Results from the first rerun with injections at higher distance.}
                        \label{fig:missinj2}
                \end{figure}
        ...
        the result of a blip like glitch around trigger time.
                \begin{figure}[h]
                        ...
                        \centering
                        \caption{Glitch follow up: re-weigted SNR vs GPS time.}
                        \label{fig:glitch_grb}
                \end{figure}
	Fig.$\ref{fig:missinj2_3}$ shows the results for the Found/Missed injections for the second rerun analysis, 
	with higher distances for BNS (375Mpc) and NSBH (700Mpc) injection set,
	in order to maximise the number of injections at close distances where most injections get lost.
	Furthermore, a new threshold was chosen for the single SNR cut:
	instead of a threshold value of four, as discussed in Sec.$\ref{subsec:pygrb}$,
	now any triggers with $\rho_X<0$ are discharged.
	As a consequence of these choices, the last  rerun shows better results:
	higher 90\% exclusion distances for both BNS and NSBH, 
	with $D_{90}\sim$118Mpc and $D_{90}\sim$134Mpc respectively.
	Within 118Mpc, out of all the BNS set of injections twenty of them are not recovered confidently.
	They all have at least one spin magnitude $>$0.05, that also causes precession,
	besides two injections that have high $\chi^2$ and NullSNR values instead.
	Given the improved results, the analysis has procede to further investigate the insource data.
	However,  since the final results are not yet public, we cannot disclose them.
                \begin{figure}[h]
                        \noindent
                        \label{missinj2_3}
                        \makebox[\textwidth]{\includegraphics[scale=0.4]{missinj2_3}}%
                        \centering
                        \caption{\textbf{Found/missed injections.}Same as Fig.$\ref{fig:missinj1}$ but for GRB 190728271. Results from the second rerun with injections at higher distance.}
...
% \subsection{Chunk 29}
	...
	during which the coincident time was of 6.235 days (72\%) and the detector sensitivity is shown on the right panel of Fig.\,\ref{fig:range_time}.
                \begin{figure}[h]
                        \noindent
                        \label{range_time}
                        \makebox[\textwidth]{\includegraphics[scale=0.5]{range_time}}%
                        \centering
	...
	The same goes for L1: there  are no potential GW events and mostly scattered light. 
                \begin{figure}[h]
                        \noindent
                        \label{glitch}
                        \makebox[\textwidth]{\includegraphics[scale=0.5]{glitch}}%
                        \centering
