...
\subsection{Description of laser interferometers}
	...
	The GW detectors offer the possibility of very high sensitivities over a wide range of frequency and
        ...
        such as binary black hole, BBH, or neutron star coalescences, asymmetric rapidly spinning neutron stars,
        and supernovae.
...
\subsubsection{Compact Binary Spin}
	...
	on black holes in binaries, possibly close to the Kerr limit $|\mathbf{S}/m^2| = |\mathbf{\chi}| = 1$.
...
\chapter{Gravitational wave observation so far}
	...
	defined as the average distance at which we can detect a binary neutron star (BNS) merger
	assuming each neutron star with mass of 1.4 ${M_\odot}$ with a SNR of 8, 
...
\section{O1: first observing run}
	...
	within the range expected for stellar-mass black holes. 
...
\subsection{GW150914 BBH}
	...
	It is recovered with a reweighted SNR in the PyCBC analysis of 22.7 and a log likelihood of $84.7$ in the GstLAL analysis. 
	...
	Following the inspiral, the BBHs merge to form a final remnant black hole, that has a mass of $M^{source}_f = 62.3^{+3.7}_{-3.1}M_\odot$.
	This result is coherent with the expected final remnant black hole mass, which is usually 0.95–0.98 of the initial 
	...
	The results obtained for GW150914 are consistent with expectations for moderately spinning black holes \cite{101, 102}. 
	...
	The spin of the final black hole, like its mass, is calculated using fitting formulas 
	calibrated against numerical relativity simulations.
	The final black holes for GW150914 has spin of $0.68^{+0.05}_{-0.06}$ as expected for mergers of similar-mass black holes \cite{99, 100}. 
