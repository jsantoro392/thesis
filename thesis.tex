...
\label{sec:pycbc00}
	...
	the chunk ends as soon as the same starting network configuration is availbel.
        This time period is long enough to get a good background estimate, 
	but short enough that the sensitivity of the instruments does not change too much. 
	...
	the histograms of the background SNR and re-weighted SNR, Fig.\ref{}, 
	...
	With the new data quality information, the search analysis is then repeated.
        ...
        \begin{figure}[!t]
          \noindent
          \label{snrhistogram}
	  \makebox[\textwidth]{\includegraphics[width=0.69\textwidth]{snrhistogram}%
	  \centering
	...
	Final results for the calculated sensitivity of the search are shown in  Fig.\ref{}: 
...
%H1_Loudest
	...
	Besides short blips, \fpg{quanti?} five \emph{scratchy blips} spanning a duration of $\gtrsim 2\,$s were identified in the second bin.
