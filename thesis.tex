...
\subsubsection{Coherent False Alarm Probability}
	...
	The data is then reanalysed, identifying the the loudest trigger in each off-source-trial.
	...
	the FAP of the on-source trigger is then the fraction of off-source trials containing a loudest trigger  than the on-source.
